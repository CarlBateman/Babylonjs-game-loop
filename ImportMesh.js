window.addEventListener('DOMContentLoaded', function () {
  ...
  var createScene = function () {
    ...
    BABYLON.SceneLoader.ImportMesh("", "models/", "companion-cube-1x1.gltf", scene, function (meshes) {
      let mesh = meshes[0];
      t = mesh;
      ...
      //  newInstance1.position.y = 1.1 + index * 1.1;
    ...
    BABYLON.SceneLoader.ImportMesh("", "models/", "companion-tetrahedron.gltf", scene, function (meshes) {
      let mesh = meshes[0];
      mesh.position.y = 0.5;
      mesh.position.x = -1.0;
      mesh.rotation.x = Math.PI / 3;
